...
try:
    if chon == '1.1':
        run = requests.get(f'https://raw.githubusercontent.com/dhphuoc/maindhp312/refs/heads/main/obf-tds.py').text
    elif chon == '1.2':
        run = requests.get(f'https://raw.githubusercontent.com/dhphuoc/maindhp312/refs/heads/main/obf-igtds.py').text
    elif chon == '1.3':
        run = requests.get(f'').text
    elif chon == '1.4':
        run = requests.get(f'').text
    elif chon == '2.1':
        run = requests.get(f'https://raw.githubusercontent.com/dhphuoc/maindhp312/refs/heads/main/obf-ttcfb.py').text
    elif chon == '2.2':
        run = requests.get(f'').text
    elif chon == '2.3':
        run = requests.get(f'https://raw.githubusercontent.com/dhphuoc/maindhp312312/refs/heads/main/obf-ttcpage.py').text 
    elif chon == '2.4':
        run = requests.get(f'https://raw.githubusercontent.com/dhphuoc/maindhp312/refs/heads/main/obf-ttctiktok.py').text 
    else:
